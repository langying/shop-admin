...
function getGrid() {
	$('#dataGrid').bootstrapTableEx({
		...
		columns: [
			{checkbox: true},
			{field : "name", title : "栏目名称", width : "100px"},
            { field: 'imgUrl', title: '栏目LOGO',width : "120px",
			...
			{field : "describe", title : "栏目描述", width : "100px"}, 
			{field : "amountScope", title : "金额范围", width : "100px"},
            {
                field : "type",
                title : "是否主推",
                width : "60px",
...
var vm = new Vue({
	...
	methods : {
		...
		save: function() {
			dialogOpen({
				title: '新增产品栏目表',
				url: 'base/column/add.html?_' + $.now(),
				width: '620px',
				height: '500px',
		...
		edit: function() {
			...
			if(checkedRow(ck)){
				dialogOpen({
					title: '编辑产品栏目表',
					url: 'base/column/edit.html?_' + $.now(),
					width: '620px',
					height: '500px',
					success: function(iframeId){
						top.frames[iframeId].vm.tColumn.id = ck[0].id;
