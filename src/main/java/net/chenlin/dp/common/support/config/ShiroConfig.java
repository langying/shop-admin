...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shirFilter(SecurityManager securityManager) {
        ...
        filterMap.put("/app/comm/upload", "anon");
        filterMap.put("/app/comm/select", "anon");
        filterMap.put("/app/agentLog/export", "anon");
        filterMap.put("/app/productLog/export", "anon");
        filterMap.put("/upload/template/*.jpg", "anon");
