...
public class JiGuangUtil implements JiGuangClient {
    ...
    @Override
    public String pushMsgByAlias(
            String message, List<String> aliasList,
    ...
    @Override
    public String scheduleMsgByTag(
            String message, String name, String tag, String time,
            Map<String, String> extras) {
    ...
    @Override
    public String pushMsgByTagList(
            String message, List<String> tagList,
            Map<String, String> extras) {
        PushResult result = null;
        try {
     ...
     * 极光推送：向所有的用户发送通知信息
     */
    public static PushPayload alertPlatformAll(String alert, String channel, Map<String, String> extras) {

        if (channel.equals("android")) {
            return new Builder().setPlatform(Platform.android()).setAudience(Audience.all())
                    .setNotification(
                            Notification
                                    .newBuilder()
                                    .setAlert(alert)
            ...
            return new Builder().setPlatform(Platform.ios()).setAudience(Audience.all())
                    .setNotification(
                            Notification
                                    .newBuilder()
                                    .setAlert(alert)
    ...
    public String pushMsgAll(String message, Map<String, String> extras) {
        PushResult result = null;
        try {
            PushPayload payload = alertPlatformAll(message, null, extras);
            result = getInstance().sendPush(payload);
            logger.info("push result is " + result);
        } catch (APIConnectionException e) {
            // TODO Auto-generated catch block  
    ...
    @Override
    public String pushChannel(String message, String channel, Map<String, String> extras) {
        PushResult result = null;
        try {
            PushPayload payload = alertPlatformAll(message, channel, extras);
            result = getInstance().sendPush(payload);
            logger.info("push result is " + result);
        } catch (APIConnectionException e) {
            // TODO Auto-generated catch block
